...
[Unique ID Schema] The unique id column CDS_CODE in dataset grad17 is the primary key column.
*/
...
[Dataset Description] SGraduates meeting University of California (UC)/California State University (CSU) entrance requirements by racial/ethnic group and school, AY2015-16
...
[Data Dictionary] https://www.cde.ca.gov/ds/sd/sd/fsgrad09.asp
[Unique ID Schema] The unique id column CDS_CODE in dataset grad16 is the primary key column.
*/
...
[Dataset Description] Assignment data for all K-12 California public education certificated teachers, administrators, and pupil services personnel, AY2016-17
[Experimental Unit Description] K-12 California public education certificated teachers, administrators, and pupil services personnel, AY2016-17
[Number of Observations] 40,000
[Number of Features] 5
[Data Source] The file
http://www3.cde.ca.gov/download/dq/StaffAssign16.zip
was downloaded, imported into R with all columns setting to Character class. To make the file less than 5MB, 40000 rows were picked out of all the observation units randomly , and all the columns except 'DistrictCode', 'SchoolCode', 'StaffType', 'EstimatedFTE' and 'File Created' were removed. The R dateframe produced was then imported into Excel to produce file StaffAssign.xls 
[Data Dictionary] http://www.cde.ca.gov/ds/sd/sd/fsgradaf09.asp
[Unique ID Schema] The columns "District Code" and "School Code" form a composite key, which together are equivalent to the unique id column CDS_CODE in dataset grad16 and grad17.
*/
...
was downloaded, imported into R with all columns setting to Character class. As not all the schools have a considerably large number of Grade 12 students, rows with the value of column 'GR_12' less than 10 were removed. All the columns except 'CDS_CODE', 'ETHNIC', 'GENDER' and 'GR_12' were removed.
[Data Dictionary] https://www.cde.ca.gov/ds/sd/sd/fsenr.asp
[Unique ID Schema] The unique id column CDS_CODE in dataset enr16 is the primary key column.
*/
